        ...
        <Dropdown
          ...
          trigger={
              <Button className="p-1 hover:bg-gray-200 shadow-none rounded">
                <Icon name="dots-horizontal" color="black" size="medium" />
              </Button>
          }
          className="px-4"
          dropClassName="w-48 bg-white rounded shadow-lg"
        >
          <ul class="pb-4">
            <li class="pt-4 pb-2">
              <div class="font-bold uppercase text-sm text-gray-700 ml-4">{desktop.primary.label}</div>
            </li>
            {desktop.primary.items.map((item) => (
